...
import com.example.deniska.IngredientRef;
...
public class JdbcOrderRepository implements OrderRepository{
    ...
    public TacoOrder save(TacoOrder order) {
        String sql ="insert into Taco_Order (delivery_name," +
                "delivery_street, delivery_city, delivery_state, delivery_zip," +
                "cc_number, cc_exp, cc_cvv, placed_at) values(?,?,?,?,?,?,?,?,?)";
        PreparedStatementCreatorFactory pscf =
                new PreparedStatementCreatorFactory(
                        sql, Types.VARCHAR, Types.VARCHAR,
                        Types.VARCHAR, Types.VARCHAR,
                        Types.VARCHAR, Types.VARCHAR,
                        Types.VARCHAR, Types.VARCHAR, Types.TIMESTAMP);
        pscf.setReturnGeneratedKeys(true);//возвращение сгенерированных ключей
